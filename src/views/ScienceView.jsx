...
export default function ScienceView () {
    ...
    return (
        <div className="flex flex-1 flex-col overflow-auto h-full min-h-0" ref={containerRef} style={{ userSelect: 'none' }}>
                            ...
                            <div className="flex flex-row">
                                <Box sx={{width:'60%', overflowX: 'auto' }}>
                                    <div className="steps flex">
                                        ...
                                        <div className="step step-accent">Step 10</div>
                                    </div>
                                </Box>
                                <Box className='flex flex-row' sx={{ ml: 4}}> Coordinates: (_,_) <br/> Accuracy: ___ <br/> Range: ___ <br/>
